...
RSpec.describe ImportsController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      import = Import.create! valid_attributes
      get :show, params: {id: import.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested import" do
        import = Import.create! valid_attributes
        put :update, params: {id: import.to_param, import: new_attributes}, session: valid_session
        import.reload
      ...
      it "redirects to the import" do
        import = Import.create! valid_attributes
        put :update, params: {id: import.to_param, import: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        import = Import.create! valid_attributes
        put :update, params: {id: import.to_param, import: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested import" do
      import = Import.create! valid_attributes
      expect {
        delete :destroy, params: {id: import.to_param}, session: valid_session
      }.to change(Import, :count).by(-1)
    end
